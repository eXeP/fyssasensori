...
import com.movesense.mds.handwave.model.FyssaDeviceInfo;
import com.movesense.mds.handwave.scanner.ScannerFragment;
import com.movesense.mds.handwave.scanner.UpdateScanActivity;
import com.movesense.mds.handwave.update_app.dfu.DfuService;
        ...
        if (wasConnected) {
            ...
            try {
                ...
                startActivity(new Intent(FyssaSensorUpdateActivity.this,
                        SelectTestActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK));
            }
        } else {

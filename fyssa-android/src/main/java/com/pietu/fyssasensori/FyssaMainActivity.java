...
public class FyssaMainActivity extends AppCompatActivity implements MovesenseContract.View, View.OnClickListener {
    ...
    public boolean checkLocationPermissionIsGranted() {
        if (ContextCompat.checkSelfPermission(FyssaMainActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(FyssaMainActivity.this,
                    Manifest.permission.ACCESS_COARSE_LOCATION)) {
                new AlertDialog.Builder(FyssaMainActivity.this)
                        ...
                        .setPositiveButton(R.string.btn_ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(FyssaMainActivity.this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_COARSE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.btn_ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                //Prompt the user once explanation has been shown
                                ActivityCompat.requestPermissions(FyssaMainActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION},
                                        MY_PERMISSIONS_REQUEST_LOCATION);
                            }
                        })
                        .create()
                ...
                .subscribe(new Action1<MdsConnectedDevice>() {
                    ...
                    public void call(MdsConnectedDevice mdsConnectedDevice) {
                        ...
                        if (mdsConnectedDevice.getConnection() != null) {
                            ...
                            startActivity(new Intent(FyssaMainActivity.this, SensorListActivity.class));
                        } else {
